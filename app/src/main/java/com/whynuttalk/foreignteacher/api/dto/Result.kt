...
import com.whynuttalk.foreignteacher.ext.ServerException
...
data class Teacher(var id: Int, var phone: String? = null, var sex: Int, var contactInformation: String? = null, var nickName: String = "", var languages: List<Language>? = null,
                   ...
                   var age: Int?) {
    class LanguagesBean(var id: Int = 0, var cName: String? = null, var eName: String? = null)
}
...
data class City(var code: String, var name: String, var id: Int) : SelectData, Serializable {
    override var enName: String
        get() = (PinyinHelper.convertToPinyinString(name, "", PinyinFormat.WITHOUT_TONE))
        set(value) {
            enName = value
        }
...
data class Nationality(var name: String) : SelectData, Serializable {
    override var enName: String = ""
        get() = name
...
class BenchmarkPrice {
    ...
    var benchmarkPrice: Any? = null
    var superBaseRatio: Any? = null
    var state: Any? = null
