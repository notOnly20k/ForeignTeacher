        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    EMLog.e(TAG, "onMessageReceived id : " + message.getMsgId());

                    //接收并处理扩展消息
                    String userName=message.getStringAttribute(Constant.NICK_NAME,"");
//                    String userId=message.getStringAttribute(Constant.USER_ID,"");
                    ...
                    Log.e("msg", "onMessageReceived:"+"helper接收到的用户名："+userName+"helper接收到的id："+"helper头像："+userPic);
            ...
            public void onCmdMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    Log.e(TAG, "receive command message");
                    //get message body
