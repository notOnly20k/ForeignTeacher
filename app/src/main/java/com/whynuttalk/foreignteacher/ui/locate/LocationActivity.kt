...
//                    if (poiItem.cityName != appComponent.userHandler.getUser().city) {
//                        showToast("This city is not open")
//                        return@onLocationClickedListener
//                    }
//                }
    ...
    private fun doSearchQuery() {
        ...
        query = PoiSearch.Query(searchKey, null, null)// 第一个参数表示搜索字符串，第二个参数表示poi搜索类型，第三个参数表示poi搜索区域（空字符串代表全国）
