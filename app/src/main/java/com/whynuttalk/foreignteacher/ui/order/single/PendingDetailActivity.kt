...
import com.whynuttalk.foreignteacher.ui.order.adapter.PendingDetailAdapter
...
class PendingDetailActivity : BaseTranslateStatusActivity() {
    ...
    override fun initView() {
        ...
        cancelAdapter.setListener(object : PendingDetailAdapter.PendingItemClickListener {
            override fun onDialogClick(type: String, bookingUserId: Int) {
                appComponent.netWork.deletePersonalTrainingOrder(id, bookingUserId)
    ...
    override fun initData() {
        ...
        appComponent.netWork.getPersonalTrainingOrderDetail(id)
                ...
                .subscribe {
                    ...
                    img_call.setOnClickListener { _ -> Utils.callPhone(this, it.phone) }
