...
import com.whynuttalk.foreignteacher.ui.square.SquareCityActivity.Companion.CURRENT_CITY
import com.whynuttalk.foreignteacher.ui.square.SquareCityActivity.Companion.SELECTCITY
import com.whynuttalk.foreignteacher.ui.square.adapter.SquareAdapter
...
class SquareFragment : BaseFragment() {
    ...
    override fun onFirstVisibleToUser() {
        ...
        tv_choose_city.setOnClickListener {
            val intent = Intent()
            intent.setClass(activity!!, SquareCityActivity::class.java)
            intent.putExtra(CURRENT_CITY, tv_choose_city.text.toString().trim())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == SELECTCITY) {
            tv_choose_city.text = data!!.getStringExtra("city")
            appComponent.userHandler.saveUser(appComponent.userHandler.getUser().copy(city = data!!.getStringExtra("city")))
        }
