 ...
 */
class SelectAToZAdapter(val context: Context, var list: List<SelectData>,val type:String) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is HeadViewHolder){
            ...
            if (type== SelectLanguageActivity.CITY){
                holder.tvLanguage.text = (this.list[realPosition] as City).name
            }else {
