 ...
 */
class IntroductionAdapter(val context: Context, var list: List<String>, val fragmentManager: FragmentManager) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == TYPE_FOOT) {
            val view = LayoutInflater.from(context).inflate(R.layout.item_add_pic, parent, false)
            AddPicViewHolder(view)
        } else {
            val view = LayoutInflater.from(context).inflate(R.layout.item_pic_match, parent, false)
            PicViewHolder(view)
        }
