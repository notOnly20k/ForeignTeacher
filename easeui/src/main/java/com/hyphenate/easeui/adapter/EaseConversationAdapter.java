...
//        CrazyShadow.Builder shadowBuilder = new CrazyShadow.Builder()
//                .setContext(getContext())
//                .setDirection(CrazyShadowDirection.ALL)
//                .setShadowRadius(DensityUtil.dip2px(getContext(), 4))
//                .setBaseShadowColor(Color.parseColor("#999999"))
//                .setCorner(DensityUtil.dip2px(getContext(), 7))
//                .setBackground(Color.parseColor("#ffffff"))
//                .setImpl(CrazyShadow.IMPL_DRAW);
//        shadowBuilder.action(holder.list_itease_layout);
        // get conversation
