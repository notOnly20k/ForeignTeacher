...
public class EaseChatRowText extends EaseChatRow {
    ...
    protected void onFindViewById() {
        ...
        if (message.direct() == EMMessage.Direct.RECEIVE) {
            transBubble = findViewById(R.id.bubble_trans);
            trans = findViewById(R.id.tv_chat_trans);
        }
    }
    ...
    public void onSetUpView() {
        ...
        if (this.message.direct() == EMMessage.Direct.RECEIVE) {
            final EaseMessageAdapter adapter = (EaseMessageAdapter) this.adapter;
            if (adapter.transMap.get(position,"").equals(""))
                transBubble.setVisibility(GONE);
            else {
                transBubble.setVisibility(VISIBLE);
                trans.setText(adapter.transMap.get(position,""));
            }
            bubbleLayout.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if (itemClickListener!=null){
                        itemClickListener.onBubbleLongClick(contentView.getText().toString(),adapter,position,trans);
                    }
                    return true;
                }
            });
