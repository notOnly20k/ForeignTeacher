...
public class EaseChatRadarPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatRadarPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowRadar(cxt, message, position, adapter);
    }
